...
module ``10: I Have Here In My Hand A List`` = 
    ...
    //fix line 21 by replacing _ with something else to make the test pass!!!!!!!!
        let b = [ "apple"; "grape"; "pear"; "biscuit" ]
        let myList = "apple":: "grape":: "pear"::"biscuit"::[]    //let myList = __::__::__::__::[]
        let myOtherList = "orange"::"lemon"::"princess"::[ "queen" ]                     //let myOtherList = __::__::__::[ __ ]
        let myNextList = "lily"::"sunflower"::["daisy";"carrot"] // you may use [ and ] symbols on this line.  let myNextList = __::__::__ 
        let myLastList = "naartjie"::"raisin"::b // DO NOT use [ or ] symbols on this line!    let myLastList = __::__::__
        myList |> should equal [ "apple"; "grape"; "pear"; "biscuit" ]
    ...
    let ``10 Pattern-matching a list (Part 6).`` () =
        ...
        i |> should equal "apple"         // i |> should equal __
        j |> should equal "peach"       //j |> should equal __
    ...
    let ``11 Pattern-matching a list (Part 7).`` () =
        ...
        o |> should equal "peach"  //o |> should equal __
        p |> should equal "watermelon"   //p |> should equal __
    ...
    let ``12 Pattern-matching a list (Part 8).`` () =
        ...
        s |> should equal "peach"    //s |> should equal __
    ...
    let ``13 Pattern-matching a list (Part 9).`` () =
        ...
        let k =
            ...
            | _::t::_::u::_ -> t + u
            | _ -> "fig"
        k |> should equal "peachwatermelon"   //k |> should equal __